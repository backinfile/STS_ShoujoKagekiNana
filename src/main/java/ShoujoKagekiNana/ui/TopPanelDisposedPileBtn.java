...
public class TopPanelDisposedPileBtn extends TopPanelItem {
    private static final Texture IMG = new Texture(ModPath.makeUIPath("stage_icon.png"));
...
//        AbstractDungeon.previousScreen = AbstractDungeon.screen;
        ...
        StagePoolPilePatch.showScreen = true;
    ...
    public void render(SpriteBatch sb) {
        ...
        FontHelper.renderFontRightTopAligned(sb, FontHelper.topPanelAmountFont,
                Integer.toString(StagePoolManager.cardPool.size()),
...
//        super.onUnhover();
    ...
    public void render(SpriteBatch sb, Color color) {
        ...
        if (this.image != null) {
            ...
            sb.draw(this.image, this.x - halfWidth + halfWidth * Settings.scale, this.y - halfHeight + halfHeight * Settings.scale, halfWidth, halfHeight, (float) this.image.getWidth(), (float) this.image.getHeight(),
                    Settings.scale, Settings.scale, this.angle, 0, 0, this.image.getWidth(), this.image.getHeight(), false, false);
            if (this.tint.a > 0.0F) {
