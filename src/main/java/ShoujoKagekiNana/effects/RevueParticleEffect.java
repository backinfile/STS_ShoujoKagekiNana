...
public class RevueParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public RevueParticleEffect(AbstractCreature creature) {
...
//        this.color = new Color(MathUtils.random(0.2F, 0.3F), MathUtils.random(0.65F, 0.8F), 1.0F, 0.0F);
        this.color = new Color(MathUtils.random(0.9F, 1F), MathUtils.random(0.8F, 0.9F), MathUtils.random(0.05F, 0.15F), 0.0F);
