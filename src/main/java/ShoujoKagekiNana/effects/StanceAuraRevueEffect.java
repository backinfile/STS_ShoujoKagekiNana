...
public class StanceAuraRevueEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public StanceAuraRevueEffect(AbstractCreature creature) {
        this.img = ImageMaster.EXHAUST_L;
        this.duration = 2.0F;
        this.scale = MathUtils.random(2.7F, 2.5F) * Settings.scale;
        this.color = new Color(MathUtils.random(0.5F, 6F), MathUtils.random(0.4F, 0.5F), MathUtils.random(0.05F, 0.15F), 0.0F);
