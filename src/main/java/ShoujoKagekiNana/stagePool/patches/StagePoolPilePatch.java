...
public class StagePoolPilePatch {

    public static boolean showScreen = false;
    private static boolean showingScreen = false;
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(ModPath.makeID(StagePoolPilePatch.class.getSimpleName()));
    ...
    public static class OpenExhaustPileViewScreenPatch {
        ...
        public static void Insert(ExhaustPileViewScreen _instance) {
            if (showScreen) {
                ...
                group.clear();
                group.group.addAll(StagePoolManager.cardPool);
                showScreen = false;
                showingScreen = true;
            } else {
                showingScreen = false;
