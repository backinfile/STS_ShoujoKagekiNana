...
public class PurgeCardInBattleEffect extends AbstractGameEffect {
    ...
    public PurgeCardInBattleEffect(AbstractCard card, float x, float y) {
        this.card = card;
...
//        card.drawScale = 0.01F;
    ...
    public void update() {
        ...
        if (this.duration < HALF_DURATION) {
